...
function Suporte(props) {
  return (
    <div>
      ...
      <h2>Suporte</h2>
      <h3>
        Dúvidas? Entre em contato conosco através do nosso WhatsApp. Nosso atendimento é de segunda a sexta das 08:00 às 18:00 - Horário de Brasília (UTC-3).
      </h3>
      <div style={{ display: 'flex', alignItems: 'center', marginTop: '20px' }}>
        ...
        />
        <span style={{ fontSize: '18px' }}>(47) 9 99773-4182</span>
      </div>
      <button
        style={{
          marginTop: '20px',
        ...
        onClick={() => window.open('https://wa.me/55479997734182', '_blank')}
      >
        Enviar Mensagem
      </button>
